  ...
  <div class="app-container">
    ...
    <div class="ccInfo">
      ...
      <div class="main">
        ...
        <p class="gray" v-html="coursePublish.description"></p>
        <p>
          <span
...
export default {
  ...
  created() {
    course.getPublishCourse(this.$route.params.id).then(response => {
  ...
  methods: {
    publish() {
      this.$confirm('确定要发布该课程吗?', '提示', {
        ...
        course.publishCourse(this.$route.params.id).then(response => {
          this.$message({
            type: "success",
            message: "课程发布成功！"
          })
