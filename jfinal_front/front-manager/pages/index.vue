...
export default {
  ...
  created() {
    this.getAllBanner()
    this.getAllCourseAndTeacher()
  },
  methods: {
    getAllBanner() {//获取所有bannerList的信息
    ...
    getAllCourseAndTeacher() {
      index.getAllCourseAndTeacher().then(response => {
        this.courseList = response.data.courseItems
        this.teacherList = response.data.teacherItems
      })
    }
  }
}
